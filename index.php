...
<body>
    ...
    <div class="jumbotron jumbotron-fluid position-relative overlay-bottom" style="margin-bottom: 90px;">
        <div class="container text-center my-5 py-5">
            ...
            <h1 class="text-white display-1 mb-5">Trilok Memorial Public School</h1>
        </div>
    </div>
    <!-- Header End -->
            ...
            <div class="row">
                ...
                <div class="col-lg-7">
                    <div class="section-title position-relative mb-4">
                        ...
                        <h1 class="display-4">A Trusted School For Your Child's Growth</h1>
                    </div>
                    <p>Established in 1990, Trilok Memorial Public School has been shaping young minds from Nursery to Class 8 with a strong focus on discipline, values and academics. Our motto, 'Knowledge Is Our Weapon', reflects our commitment to giving every child the tools they need to succeed in life.</p>
                    <div class="row pt-3 mx-0">
                        <div class="col-3 px-0">
                            <div class="bg-success text-center p-4">
                                <h1 class="text-white" data-toggle="counter-up">36</h1>
                                <h6 class="text-uppercase text-white">Years of<span class="d-block">Excellence</span></h6>
                            </div>
                        </div>
                        <div class="col-3 px-0">
                            <div class="bg-primary text-center p-4">
                                <h1 class="text-white" data-toggle="counter-up">8</h1>
                                <h6 class="text-uppercase text-white">Nursery to<span class="d-block">Class 8</span></h6>
                            </div>
                        </div>
                        <div class="col-3 px-0">
            ...
            <div class="row">
                <div class="col-lg-7 my-5 pt-5 pb-lg-5">
                    <div class="section-title position-relative mb-4">
                        ...
                        <h1 class="display-4">Why Parents Choose Trilok Memorial?</h1>
                    </div>
                    <p class="mb-4 pb-2">At Trilok Memorial Public School, we believe every child deserves quality education in a caring, disciplined and joyful environment, right from Nursery to Class 8.</p>
                    <div class="d-flex mb-3">
                        ...
                        <div class="mt-n1">
                            ...
                            <p>Our teachers are experienced, patient and dedicated to helping every child learn and grow with confidence.</p>
                        </div>
                    </div>
                    <div class="d-flex mb-3">
                        ...
                        <div class="mt-n1">
                            ...
                            <p>Spacious classrooms, a well-stocked library and a safe campus designed for young learners to explore and grow.</p>
                        </div>
                    </div>
                    <div class="d-flex">
                        ...
                        <div class="mt-n1">
                            ...
                            <p class="m-0">Sports, art, music and regular school events help children build confidence beyond the classroom.</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="row mx-0 justify-content-center pt-5">
            <div class="col-lg-6">
                <div class="section-title text-center position-relative mb-4">
                    <h6 class="d-inline-block position-relative text-secondary text-uppercase pb-2">Our Classes</h6>
        ...
        <div class="owl-carousel courses-carousel">
            <div class="courses-item position-relative">
                ...
                <div class="courses-text">
                    <h4 class="text-center text-white px-3">Trilok Memorial Public School</h4>
                    ...
                    <div class="w-100 bg-white text-center p-4" >
                        <a class="btn btn-primary" href="detail.php">Class Detail</a>
                    </div>
                </div>
            </div>
            <div class="courses-item position-relative">
                ...
                <div class="col-lg-5 mb-5 mb-lg-0">
                    <div class="bg-light d-flex flex-column justify-content-center px-5" style="height: 450px;">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="mt-n1">
                                <h4>Email Us</h4>
                                <p class="m-0"> trilokmemorial74@gmail.com</p>
                            </div>
                        </div>
                    </div>
                </div>
