...
<head>
    <meta charset="utf-8">
    <title>Mandatory Public Disclosure - Trilok Memorial Public School</title>
...
<body>
    ...
    <div class="jumbotron jumbotron-fluid page-header position-relative overlay-bottom" style="margin-bottom: 90px;">
        <div class="container text-center py-5">
            <h1 class="text-white display-1">Mandatory Public Disclosure</h1>
            <div class="d-inline-flex text-white mb-5">
                <p class="m-0 text-uppercase"><a class="text-white" href="index.php">Home</a></p>
                <i class="fa fa-angle-double-right pt-1 px-3"></i>
                <p class="m-0 text-uppercase">Mandatory Public Disclosure</p>
            </div>
        </div>
    </div>
    <!-- Header End -->
            ...
            <div class="row mx-0 justify-content-center">
                <div class="col-lg-10">
                    <div class="section-title text-center position-relative mb-5">
                        <h6 class="d-inline-block position-relative text-secondary text-uppercase pb-2">As Per CBSE Norms</h6>
                        <h1 class="display-4">Mandatory Public Disclosure</h1>
                    </div>
                    ...
                    <h4 class="mb-3">B: Documents and Information</h4>
                    <div class="table-responsive mb-5">
                        <table class="table table-bordered">
                    ...
                    <div class="table-responsive mb-5">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr><td>1</td><td>School Academic Session Period</td><td>To be updated</td></tr>
                                <tr><td>2</td><td>Vacation Period</td><td>To be updated</td></tr>
                                <tr><td>3</td><td>Admission Period</td><td>To be updated</td></tr>
                            </tbody>
                        </table>
                    </div>
