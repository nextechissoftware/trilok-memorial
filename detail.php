...
<body>
    ...
    <div class="jumbotron jumbotron-fluid page-header position-relative overlay-bottom" style="margin-bottom: 90px;">
        <div class="container text-center py-5">
            <h1 class="text-white display-1">Class Detail</h1>
            <div class="d-inline-flex text-white mb-5">
                <p class="m-0 text-uppercase"><a class="text-white" href="">Home</a></p>
                <i class="fa fa-angle-double-right pt-1 px-3"></i>
                <p class="m-0 text-uppercase">Class Detail</p>
            </div>
        </div>
    </div>
    <!-- Header End -->
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="mb-5">
                        <div class="section-title position-relative mb-5">
                            <h6 class="d-inline-block position-relative text-secondary text-uppercase pb-2">Class Detail</h6>
                            <h1 class="display-4">Primary Wing (Class 1 - 5)</h1>
                        </div>
                        <img class="img-fluid rounded w-100 mb-4" src="img/header.jpg" alt="Image">
                        <p>The Primary Wing at Trilok Memorial Public School focuses on building strong basics in language, mathematics and general awareness. Our teachers use activity-based, interactive learning to make every subject engaging and easy to understand for young learners.</p>

                        <p>Along with academics, students take part in art, craft, music and physical activities that help them grow in confidence. Regular assessments and parent-teacher meetings keep families informed about each child's progress throughout the year.</p>
                    </div>

                    <h2 class="mb-3">Other Classes</h2>
                    <div class="owl-carousel related-carousel position-relative" style="padding: 0 30px;">
                        <a class="courses-list-item position-relative d-block overflow-hidden mb-2" href="detail.php">
                            <img class="img-fluid" src="img/courses-1.jpg" alt="">
                            <div class="courses-text">
                                <h4 class="text-center text-white px-3">Nursery - UKG</h4>
                                <div class="border-top w-100 mt-3">
                                    <div class="d-flex justify-content-between p-4">
                                        <span class="text-white"><i class="fa fa-user mr-2"></i>Class Teacher</span>
                                    </div>
                                </div>
                            </div>
                        </a>
                        <a class="courses-list-item position-relative d-block overflow-hidden mb-2" href="detail.php">
                            ...
                            <div class="courses-text">
                                <h4 class="text-center text-white px-3">Middle Wing (Class 6 - 8)</h4>
                                <div class="border-top w-100 mt-3">
                                    <div class="d-flex justify-content-between p-4">
                                        <span class="text-white"><i class="fa fa-user mr-2"></i>Class Teacher</span>
                                    </div>
                        ...
                        <a class="courses-list-item position-relative d-block overflow-hidden mb-2" href="detail.php">
                            ...
                            <div class="courses-text">
                                <h4 class="text-center text-white px-3">Co-Curricular Activities</h4>
                                <div class="border-top w-100 mt-3">
                                    <div class="d-flex justify-content-between p-4">
                                        <span class="text-white"><i class="fa fa-user mr-2"></i>Class Teacher</span>
                                    </div>
                ...
                <div class="col-lg-4 mt-5 mt-lg-0">
                    <div class="bg-primary mb-5 py-3">
                        <h3 class="text-white py-3 px-4 m-0">Class Information</h3>
                        <div class="d-flex justify-content-between border-bottom px-4">
                            <h6 class="text-white my-3">Age Group</h6>
                            <h6 class="text-white my-3">6 - 10 Years</h6>
                        </div>
                        <div class="d-flex justify-content-between border-bottom px-4">
                            <h6 class="text-white my-3">Sections</h6>
                            <h6 class="text-white my-3">Class 1 to 5</h6>
                        </div>
                        <div class="d-flex justify-content-between border-bottom px-4">
                            <h6 class="text-white my-3">School Days</h6>
                            <h6 class="text-white my-3">Mon - Sat</h6>
                        </div>
                        <div class="d-flex justify-content-between border-bottom px-4">
                            <h6 class="text-white my-3">School Timing</h6>
                            <h6 class="text-white my-3">To be updated</h6>
                        </div>
                        <div class="d-flex justify-content-between px-4">
                            <h6 class="text-white my-3">Medium</h6>
                            <h6 class="text-white my-3">English / Hindi</h6>
                        </div>
                        <div class="py-3 px-4">
                            <a class="btn btn-block btn-secondary py-3 px-5" href="contact.php">Enquire Now</a>
                        </div>
                    </div>

                    <div class="mb-5">
                        <h2 class="mb-3">Subjects Taught</h2>
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                                <a href="" class="text-decoration-none h6 m-0">Environmental Science</a>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                                <a href="" class="text-decoration-none h6 m-0">Hindi</a>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                                <a href="" class="text-decoration-none h6 m-0">Computer Basics</a>
                            </li>
                        </ul>
                    </div>

                    <div class="mb-5">
                        <h2 class="mb-4">Other Classes</h2>
                        <a class="d-flex align-items-center text-decoration-none mb-4" href="">
                            <img class="img-fluid rounded" src="img/courses-80x80.jpg" alt="">
                            <div class="pl-3">
                                <h6>Nursery - UKG</h6>
                                <div class="d-flex">
                                    <small class="text-body mr-3"><i class="fa fa-user text-primary mr-2"></i>Foundational Years</small>
                        ...
                        <a class="d-flex align-items-center text-decoration-none mb-4" href="">
                            <img class="img-fluid rounded" src="img/courses-80x80.jpg" alt="">
                            <div class="pl-3">
                                <h6>Primary Wing (Class 1 - 5)</h6>
                                <div class="d-flex">
                                    <small class="text-body mr-3"><i class="fa fa-user text-primary mr-2"></i>Classes 1 to 5</small>
                        ...
                        <a class="d-flex align-items-center text-decoration-none mb-4" href="">
                            <img class="img-fluid rounded" src="img/courses-80x80.jpg" alt="">
                            <div class="pl-3">
                                <h6>Middle Wing (Class 6 - 8)</h6>
                                <div class="d-flex">
                                    <small class="text-body mr-3"><i class="fa fa-user text-primary mr-2"></i>Classes 6 to 8</small>
                        ...
                        <a class="d-flex align-items-center text-decoration-none" href="">
                            ...
                            <div class="pl-3">
                                ...
                                <div class="d-flex">
                                    <small class="text-body mr-3"><i class="fa fa-user text-primary mr-2"></i>Sports, Art & Music</small>
